...
API_URL="https://api.modrinth.com/v2/project/$PROJECT/version?loaders=%5B%22$LOADER%22%5D&game_versions=%5B%22$MINECRAFT_VERSION%22%5D&include_changelog=false"
